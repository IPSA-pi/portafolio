    ...
    <div class="max-w-2xl mx-auto px-8 py-12">
        ...
        <section class="space-y-6">
            ...
            <div>
                ...
                <p class="mt-3 text-gray-700 dark:text-white leading-relaxed">
                    Payments are processed by Stripe, Inc. By completing a purchase, you also agree to <a href="https://stripe.com/legal" class="underline text-gray-800 dark:text-white hover:text-black dark:hover:text-white transition-colors" target="_blank" rel="noopener">Stripe's Terms of Service</a>. Payment card data never passes through or is stored on this site's servers.
                </p>
            </div>
