    ...
    <div class="max-w-2xl mx-auto px-8 py-12">
        ...
        <section class="space-y-6">
            ...
            <div>
                ...
                <p class="mt-3 text-gray-700 dark:text-white leading-relaxed">
                    Stripe's own privacy policy governs how they handle your payment data: <a href="https://stripe.com/privacy" class="underline text-gray-800 dark:text-white hover:text-black dark:hover:text-white transition-colors" target="_blank" rel="noopener">stripe.com/privacy</a>.
                </p>
            </div>
